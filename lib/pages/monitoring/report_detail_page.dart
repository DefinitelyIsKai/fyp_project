...
class _ReportDetailPageState extends State<ReportDetailPage> {
      ...
      builder: (_) => AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Text(
                'You are about to issue a warning to the reported user.',
                style: TextStyle(
                  fontSize: 15,
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              await _issueWarningToUser(userId, violationReason);
            },
            style: ElevatedButton.styleFrom(
  ...
  Future<void> _issueWarningToUser(String userId, String violationReason) async {
    setState(() => _isProcessing = true);
    try {
