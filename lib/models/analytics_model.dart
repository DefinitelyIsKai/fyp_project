class AnalyticsModel {
  ...
  final double userGrowthRate; // percentage
  final double activeUserGrowth; // percentage
  final double registrationGrowth; // percentage
  final double sessionGrowth; // percentage
  final double engagementGrowth; // percentage
  final double applicationGrowth; // percentage
  final double messageGrowth; // percentage
  final double profileViewGrowth; // percentage
  final double jobPostGrowth; // percentage
  final double reportGrowth; // percentage
  final double reportedMessageGrowth; // percentage
  final double creditUsageGrowth; // percentage
  final double subscriptionGrowth; // percentage
  final double revenueGrowth; // percentage
  final double purchaseGrowth; // percentage
